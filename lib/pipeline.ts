...
export const PIPELINE_ID = 'leasecraft-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 · Clause type & state",
  process: "Step 2/3 · Draft plain-English language",
  output: "Step 3/3 · Drop-in lease clause",
}
