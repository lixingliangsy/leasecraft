...
export const PRODUCT = {
  name: "LeaseCraft",
  slug: "leasecraft",
  productId: "PROD_1zgJCfy3eCEFW8aLkLvXiC",
  priceMonthly: 15,
  yearlyProductId: "PROD_78ObgxzmpbYfK4xLIg0cSH",
  priceYearly: 150,

  checkoutUrl: "https://pancake.waffo.ai/store/lixingliang-ai-tools-6cilbw8v/checkout/cs_66749e1e-0a7d-52e4-7d0e-dfacf838e95c",
  ...
  definitionLead: "LeaseCraft produces plain-English lease clauses for common situations — late rent, pets, deposits — state-aware and drop-in ready. It is a template, not legal advice.",
  geoFaq: [
    { q: "What is LeaseCraft?", a: "LeaseCraft generates plain-English lease clauses for situations like late rent, pets, and deposits, state-aware and drop-in ready." },
    { q: "Which clauses does it cover?", a: "Common situations such as late rent, pets, and deposits." },
    { q: "Is it legal advice?", a: "No. It is a template, not legal advice; review with counsel before use." },
    { q: "Does it cover my state?", a: "It uses state-aware framing so the language fits your location's context." },
    { q: "Who is it for?", a: "Landlords and tenants who want readable clause language to drop into an agreement." },
    { q: "Are both sides covered?", a: "It provides landlord and tenant sides for the clause." },
  ],
