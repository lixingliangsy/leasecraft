  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://leasecraft.lxsaihub.com/" />
      
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is LeaseCraft?", "acceptedAnswer": {"@type": "Answer", "text": "LeaseCraft generates plain-English lease clauses for situations like late rent, pets, and deposits, state-aware and drop-in ready."}}, {"@type": "Question", "name": "Which clauses does it cover?", "acceptedAnswer": {"@type": "Answer", "text": "Common situations such as late rent, pets, and deposits."}}, {"@type": "Question", "name": "Is it legal advice?", "acceptedAnswer": {"@type": "Answer", "text": "No. It is a template, not legal advice; review with counsel before use."}}, {"@type": "Question", "name": "Does it cover my state?", "acceptedAnswer": {"@type": "Answer", "text": "It uses state-aware framing so the language fits your location's context."}}, {"@type": "Question", "name": "Who is it for?", "acceptedAnswer": {"@type": "Answer", "text": "Landlords and tenants who want readable clause language to drop into an agreement."}}, {"@type": "Question", "name": "Are both sides covered?", "acceptedAnswer": {"@type": "Answer", "text": "It provides landlord and tenant sides for the clause."}}]}` }} />
        </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">LeaseCraft - definition</h2>
...
<section id="features" className="py-20">
        ...
        <section id="testimonials" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-extrabold text-center mb-12">Trusted by operators who ship</h2>
            <div className="max-w-3xl mx-auto text-center rounded-2xl border border-dashed border-slate-300 bg-white p-10">
              <div className="text-amber-400 mb-3 text-2xl">★★★★★</div>
              <p className="text-slate-700 mb-4">
                Real customer stories are published here once users agree to be quoted. We do not invent testimonials.
              </p>
              <p className="text-sm text-slate-500">
                Want to be our first featured story? <a href="#signup" className="text-indigo-600 font-semibold underline">Start free</a> and tell us your result.
              </p>
            </div>
          </div>
        </section>
