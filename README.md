...
> Clear lease clauses for any situation - late rent, pets, deposits.
>
> Pick the clause you need and your state, and get plain-English lease language you can drop straight into your agreement - marked as a template, not legal advice.
...
```bash
npm run build
# Vercel: import repo, set framework = Next.js, root = 12_Micro_SaaS/<slug>
```
