...
const howToSteps = [
  { name: 'Open LeaseCraft', text: 'Go to the workspace and enter the inputs LeaseCraft asks for.' },
  { name: 'Generate the draft', text: 'Run LeaseCraft to get a structured plain-English result.' },
...
export default function Page() {
  ...
  const SHORT = "LeaseCraft produces plain-English lease clauses for common situations."
  return (
    <>
      <Head>
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-lg font-semibold text-slate-900" data-geo-short-lead="1">LeaseCraft produces plain-English lease clauses for common situations.</p>
